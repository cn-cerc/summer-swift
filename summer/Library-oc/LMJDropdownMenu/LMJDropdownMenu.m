...
- (void)createMainBtnWithFrame:(CGRect)frame{
    ...
    [_mainBtn setBackgroundColor:[UIColor clearColor]];
    ...
    // 旋转尖头
    _arrowMark = [[UIImageView alloc] initWithFrame:CGRectMake(_mainBtn.frame.size.width - 15, 0, 12, 9)];
    _arrowMark.center = CGPointMake(frame.size.width - 20, frame.size.height/2);
    _arrowMark.image  = [UIImage imageNamed:@"arrow_down"];
