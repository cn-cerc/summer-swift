...
inline Vec2F ImageTargetParameters::size()
{
    auto _return_value_ = easyar_ImageTargetParameters_size(cdata_.get());
    return Vec2F{{{_return_value_.data[0], _return_value_.data[1]}}};
}
inline void ImageTargetParameters::setSize(Vec2F arg0)
{
    easyar_ImageTargetParameters_setSize(cdata_.get(), easyar_Vec2F{{arg0.data[0], arg0.data[1]}});
}
